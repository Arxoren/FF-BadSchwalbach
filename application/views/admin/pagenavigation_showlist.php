...
<div id="admin_contentbox">
		...
		<?php
			...
			foreach($content['menueitems'] as $menue) {
				...
				echo'<li class="'.$linestyle.'""><div>';
					...
					echo'<div class="admin_delete"><a href="'.base_url().'admin/?op=pagenavigation_delete&target=pagenavigation_showlist&id='.$menue['navID'].'&wehrID='.$content['akt_wehr'].'" class="js_admin_dialogbox" data-box="deleteswitch" data-func="complete">Delete</a></div>';
	...
	<div class="admin_modaldialog admin_hide" id="js_admin_dialog_deleteswitch">
		...
		<hr class="clear" />
		<h1 class="admin">Menüpunkt löschen</h1>
		<p class="admin">Möchten Sie den Menüpunkt komplett oder nur für die aktuelle Ansicht (<?php echo $wehrname; ?>) entfernen?</p>
		<p class="admin_panel">
			<a href="#" class="admin_button" id="js_admin_dialog_opt1">Komplett löschen</a>
			<a href="#" class="admin_button" id="js_admin_dialog_opt2">Nur für "<strong><?php echo $wehrname; ?></strong>" löschen</a>
		</p>
	</div>